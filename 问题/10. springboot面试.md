...
- - 28.如何重新加载 Spring Boot 上的更改，而无需重新启动服务器？29.Spring Boot项目如何热部署？
  - 30.您使用了哪些 starter maven 依赖项？
  - 31.Spring Boot 中的 starter 到底是什么 ?
  - 32.spring-boot-starter-parent 有什么用 ?
  - 33.Spring Boot 打成的 jar 和普通的 jar 有什么区别 ?
  - 34.运行 Spring Boot 有哪几种方式？
  - 35.Spring Boot 需要独立的容器运行吗？
  - 36.开启 Spring Boot 特性有哪几种方式？
  - 37.如何使用 Spring Boot 实现异常处理？
  - 38.如何使用 Spring Boot 实现分页和排序？
  - 39.微服务中如何实现 session 共享 ?
  - 40.Spring Boot 中如何实现定时任务 ?
